...
const Skeleton: React.FC<Props> = ({width, height, borderRadius, style}) => {
    ...
    return ( 
        <View style={[style, {backgroundColor: "#a0a0a0", height: height, width: width, borderRadius: borderRadius}]}>
            <AnimatedG 
            colors={['#a0a0a0', '#b0b0b0','#b0b0b0', '#a0a0a0']}
            start={{x: 0, y: 0}} end={{x: 1, y: 0}}
            style={{backgroundColor: "#a0a0a0", height: height, width: width/2, borderRadius: borderRadius, transform: [{translateX: translateX}]}} />
        </View>
    )
}
